                ...
                <div id="page-content-wrapper">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <form class="buscar" action="frmListarEmpresas.jsp" method="post">
                                ...
                                <tbody>
                                    ...
                                    <%
                                        ...
                                        if (request.getParameter("txtnombre") != null) {
                                            ...
                                            condicion = "NOMBRE_EMPRESA LIKE '%" + nombre + "%'";
                                        }
                                        BLEmpresas logica = new BLEmpresas();
                                        List<EntidadEmpresa> datos;
                                        datos = logica.ListarEmpresas(condicion);

                                        //for para llenar la tabla
                                        for (EntidadEmpresa registro : datos) {
                                    %>
                                    <tr>
                                        <% int codigo = registro.getCodEmpresa();%>
                                        <td><%=codigo%></td>
                                        <td><%=registro.getCedulaJuridica()%></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="frmEmpresas.jsp?idCrearModificar=<%=codigo%>"> <i id="edit" class="fas fa-user-edit"></i> </a> |
                                            <!--Botón para Eliminar -->
                                            <a href="EliminarEmpresa?idEliminar=<%=codigo%>"> <i id="delete" class="fas fa-trash-alt"></i> </a> |
                                        </td>
                                    </tr>
                                    <%}%><!--Para cerrar el for --> 
                                </tbody>
                        ...
                        <a href="frmEmpresas.jsp?idCrearModificar=-1"> Agregar una nueva Empresa </a> |
                        <a href="frmListarEmpresas.jsp"> Actualizar </a> |
