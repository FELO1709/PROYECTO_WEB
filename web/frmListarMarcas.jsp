                ...
                <div id="page-content-wrapper">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <form action="frmListarMarcas.jsp" method="post">
                                ...
                                <tbody>
                                    ...
                                    <% 
                                        ...
                                        if(request.getParameter("txtnombre")!=null){
                                            ...
                                            condicion = "NOMBRE_MARCA LIKE '%" + nombre + "%'";
                                        }
                                        BLMarcas logica = new BLMarcas();
                                        List<EntidadMarca> datos;
                                        datos = logica.ListarMarcas(condicion);
            
                                        //for para llenar la tabla
                                        for (EntidadMarca registro:datos){
                                    %>
                                    <tr>
                                        <% int codigo=registro.getCodMarca();%>
                                        <td><%=codigo %></td>
                                        <td><%=registro.getNombreMarca()%></td>
                                        <!--Columna para los botones -->
                                        <td>
                                            <!--Botón para modificar -->
                                            <a href="frmMarcas.jsp?idCrearModificar=<%=codigo%>"> <i id="edit" class="fas fa-user-edit"></i> </a> |
                                            <!--Botón para Eliminar -->
                                            <a href="EliminarMarca?idEliminar=<%=codigo%>"> <i id="delete" class="fas fa-trash-alt"></i> </a> |
                                        </td>
                                    </tr>
                                    <%}%><!--Para cerrar el for --> 
                                </tbody>
                        ...
                        <a href="frmMarcas.jsp?idCrearModificar=-1"> Agregar una nueva Marca </a> |
                        <a href="frmListarMarcas.jsp"> Actualizar </a> |
