...
<%@page import="LogicaNegocio.BLClientes"%>
<%@page import="Entidades.EntidadCliente"%>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
                            ...
                            <div class="col-md-8 mx-auto">
                                ...
                                <%
                                    ...
                                    if (codigo > 0) {
                                        ...
                                        cliente = logica.ObtenerRegistro("COD_CLIENTE=" + id);
                                    } else {
                                        // Sino, crea uno nuevo
                                ...
                                <form action="CrearModificarCliente" method="post" id="form_AgregarModificar">                 
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="txtCodigo" name="txtCodigo" value="<%=cliente.getCodCliente()%>" readonly class="form-control"/><br>
                                        <%} else {%>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="txtCedula" name="txtCedula" value="<%=cliente.getCedula()%>" class="form-control"/><br>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="txtApellido1" name="txtApellido1" value="<%=cliente.getApellido1()%>" class="form-control"/><br>
                                    </div><!-- comment -->

                                    <!-- form-group para los controles de apellido 2 -->
                                    <div class="form-group">
                                        <label for="txtApellido2" class="control-label">2do Apellido</label>
                                        <input type="text" id="txtApellido2" name="txtApellido2" value="<%=cliente.getApellido2()%>" class="form-control"/><br>
                                    </div>

                                    <!-- form-group para los controles de Teléfono -->
                                    <div class="form-group">
                                        <label for="txtTelefono" class="control-label">Teléfono</label>
                                        <input type="text" id="txtTelefono" name="txtTelefono" value="<%=cliente.getTelefono()%>" class="form-control" placeholder="00-00-00-00"/><br>
                                    </div>

                                    <!-- form-group para los controles de Correo -->
                                    <div class="form-group">
                                        <label for="txtCorreo" class="control-label">Correo</label>
                                        <input type="text" id="txtCorreo" name="txtCorreo" value="<%=cliente.getCorreo()%>" class="form-control"/><br>
                                    </div>

                                    <!-- form-group para los controles de Dirección -->
                                    <div class="form-group">
                                        <label for="txtDireccion" class="control-label">Dirección</label>
                                        <input type="text" id="txtDireccion" name="txtDireccion" value="<%=cliente.getDireccion()%>" class="form-control"/><br>
                                    </div>

                                    <!-- form-group para los controles de Dirección -->
                                    <div class="form-group">
                                        <label for="txtEstado" class="control-label">Estado</label>
                                        <input type="text" id="txtEstado" name="txtEstado" value="<%=cliente.getEstado()%>" class="form-control"><br> 
                                    </div>
