...
<%@page import="LogicaNegocio.BLMarcas"%>
<%@page import="Entidades.EntidadMarca"%>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
                            ...
                            <div class="col-md-8 mx-auto">
                                ...
                                <%
                                    ...
                                    if (codigo > 0) {
                                        ...
                                        marca = logica.ObtenerRegistro("COD_MARCA=" + id);
                                    } else {
                                        // Sino, crea uno nuevo
                                        marca = new EntidadMarca();
                                    }
                                %>

                                <form action="CrearModificarMarca" method="post" id="form_AgregarModificar">                 
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="txtCodigo" name="txtCodigo" value="<%=marca.getCodMarca()%>" readonly class="form-control"/><br>
                                        <%} else {%>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="txtNombre" name="txtNombre" value="<%=marca.getNombreMarca()%>" class="form-control"/><br>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="button" id="btnRegresar" value="Regresar" onclick="location.href = 'frmListarMarcas.jsp'" class="btn btn-secondary"/>
                                        </div>
                                    </div>
