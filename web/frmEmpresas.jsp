...
<%@page import="LogicaNegocio.BLEmpresas"%>
<%@page import="Entidades.EntidadEmpresa"%>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
                            ...
                            <div class="col-md-8 mx-auto">
                                ...
                                <%
                                    ...
                                    if (codigo > 0) {
                                        ...
                                        empresa = logica.ObtenerRegistro("COD_EMPRESA=" + id);
                                    } else {
                                        // Sino, crea uno nuevo
                                ...
                                <form action="CrearModificarEmpresa" method="post" id="form_AgregarModificar">                 
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="txtCodigo" name="txtCodigo" value="<%=empresa.getCodEmpresa()%>" readonly class="form-control"/><br>
                                        <%} else {%>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="txtCedula" name="txtCedula" value="<%=empresa.getCedulaJuridica()%>" class="form-control"/><br>
                                    </div>

                                    <!-- form-group para los controles de Nombre -->
                                    <div class="form-group">
                                        <label for="txtNombre" class="control-label">Nombre</label>
                                        <input type="text" id="txtNombre" name="txtNombre" value="<%=empresa.getNombreEmpresa()%>" class="form-control"/><br>
                                    </div>

                                    <!-- form-group para los controles de Teléfono -->
                                    <div class="form-group">
                                        <label for="txtTelefono" class="control-label">Teléfono</label>
                                        <input type="text" id="txtTelefono" name="txtTelefono" value="<%=empresa.getTelefono()%>" class="form-control" placeholder="00-00-00-00"/><br>
                                    </div>

                                    <!-- form-group para los controles de Correo -->
                                    <div class="form-group">
                                        <label for="txtCorreo" class="control-label">Correo</label>
                                        <input type="text" id="txtCorreo" name="txtCorreo" value="<%=empresa.getCorreo()%>" class="form-control"/><br>
                                    </div>

                                    <!-- form-group para los controles de Dirección -->
                                    <div class="form-group">
                                        <label for="txtDireccion" class="control-label">Dirección</label>
                                        <input type="text" id="txtDireccion" name="txtDireccion" value="<%=empresa.getDireccion()%>" class="form-control"/><br>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="button" id="btnRegresar" value="Regresar" onclick="location.href = 'frmListarEmpresas.jsp'" class="btn btn-secondary"/>
                                        </div>
                                    </div>
                    ...
                    <script>
                                                ...
                                                $(document).ready(function () {
                                                    ...
                                                    $("#form_AgregarModificar").validate({
                                                        ...
                                                        rules: {
                                                            txtCedula: {required: true, minlength: 10, maxlength: 15},
                                                        ...
                                                        messages: {
                                                            txtCedula: "El campo Cédula es obligatorio (mínimo 10 caracteres, máximo 15)",
