            ...
            <div id="wrapper">
                ...
                <div id="page-content-wrapper">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <!--Hacer una consulta a la bd para obtener la lista de productos
                                    ...
                                    <% 
                                        ...
                                        if(request.getParameter("txtnombre")!=null){
                                            descripcion = request.getParameter("txtnombre");
                                            condicion = "NOMBRE LIKE '%" + descripcion + "%'";
                                        }
                                    ...
                                    %>
                                    <tr>
                                        <% int codigo=registro.getCodProducto();%>
                                        <td><%=codigo %></td>
                                        <!--td></td>
                                        <td></td-->
                                        <td><%=registro.getNombreCategoria()%></td>
                                        <td><%=registro.getNombreMarca()%></td>
                                        <td><%=registro.getNombre()%></td>
                                        <td><%=registro.getDescripcion()%></td><!-- comment -->
                                        <td><%=registro.getExistencia()%></td><!-- comment -->
                                        <td><%=registro.getPrecioCompra()%></td>
                                        <td><%=registro.getPrecioVenta()%></td>
                                        <td><%=registro.getImpuesto()%></td>
                                        <td><%=registro.getBorrado()%></td>
                                        <!--Columna para los botones -->
                                        <td>
                                            <!--Botón para modificar -->
                                            <a href="frmProductos.jsp?idCrearModificar=<%=codigo%>"> <i id="edit" class="fas fa-user-edit"></i> </a> |
                                            <!--Botón para Eliminar -->
                                            <a href="EliminarProductos?idEliminar=<%=codigo%>"> <i id="delete" class="fas fa-trash-alt"></i> </a> |
                                        </td>
                                    </tr>
                                    <%}%><!--Para cerrar el for --> 
                                </tbody>
                        ...
                        <br> 
                        <a href="frmProductos.jsp?idCrearModificar=-1"> Agregar un nuevo Producto </a> |
                        <a href="frmListarProductos.jsp"> Actualizar </a> |
