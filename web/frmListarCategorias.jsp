                ...
                <div id="page-content-wrapper">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <form action="frmListarCategorias.jsp" method="post">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <% 
                                        ...
                                        List<EntidadCategoria> datos;
                                        datos = logica.ListarCategorias(condicion);
            
                                        //for para llenar la tabla
                                        for (EntidadCategoria registro:datos){
                                    %>
                                    <tr>
                                        <% int codigo=registro.getCodCategoria();%>
                                        <td><%=codigo %></td>
                                        <td><%=registro.getNombreCategoria()%></td>
                                        <!--Columna para los botones -->
                                        <td>
                                            <!--Botón para modificar -->
                                            <a href="frmCategorias.jsp?idCrearModificar=<%=codigo%>"> <i id="edit" class="fas fa-user-edit"></i> </a> |
                                            <!--Botón para Eliminar -->
                                            <a href="EliminarCategoria?idEliminar=<%=codigo%>"> <i id="delete" class="fas fa-trash-alt"></i> </a> |
                                        </td>
                                    </tr>
                                    <%}%><!--Para cerrar el for --> 
                                </tbody>
                        ...
                        <a href="frmCategorias.jsp?idCrearModificar=-1"> Agregar una nueva Categoría </a> |
                        <a href="frmListarCategorias.jsp"> Actualizar </a> |
