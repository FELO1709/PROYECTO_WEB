                ...
                <div id="page-content-wrapper">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <form action="frmListarVendedores.jsp" method="post">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <% 
                                        ...
                                        List<EntidadVendedor> datos;
                                        datos = logica.ListarVendedores(condicion);
            
                                        //for para llenar la tabla
                                        for (EntidadVendedor registro:datos){
                                    %>
                                    <tr>
                                        <% int codigo=registro.getCodVendedor();%>
                                        <td><%=codigo %></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="frmVendedores.jsp?idCrearModificar=<%=codigo%>"> <i id="edit" class="fas fa-user-edit"></i> </a> |
                                            <!--Botón para Eliminar -->
                                            <a href="EliminarVendedores?idEliminar=<%=codigo%>"> <i id="delete" class="fas fa-trash-alt"></i> </a> |
                                        </td>
                                    </tr>
                                    <%}%><!--Para cerrar el for --> 
                                </tbody>
                        ...
                        <a href="frmVendedores.jsp?idCrearModificar=-1"> Agregar un nuevo Vendedor </a> |
                        <a href="frmListarVendedores.jsp"> Actualizar </a> |
