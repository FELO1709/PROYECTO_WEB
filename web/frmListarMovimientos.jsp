                ...
                <div id="page-content-wrapper">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <form action="frmListarMovimientos.jsp" method="post">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <%
                                        ...
                                        BLMovimientos logica = new BLMovimientos();
                                        List<EntidadMovimiento> datos;
                                        datos = logica.ListarMovimientos(condicion);

                                        //for para llenar la tabla
                                        for (EntidadMovimiento registro : datos) {
                                    %>
                                    <tr>
                                        <% int codigo = registro.getCodMovimiento();%>
                                        <td><%=codigo%></td>
                                        <td><%=registro.getNumFactura()%></td>
                                        <td><%=registro.getFechaMov()%></td>
                                        <td><%=registro.getExistenciaInv()%></td><!-- comment -->
                                        <td><%=registro.getCantMov()%></td>
                                        <td><%=registro.getExistenciaAct()%></td>
                                    </tr>
                                    <%}%><!--Para cerrar el for --> 
                                </tbody>
                            </table>
                        ...
                        <a href="frmListarMovimientos.jsp"> Actualizar </a> |
