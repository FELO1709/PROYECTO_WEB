            ...
            <div id="wrapper">
                ...
                <div id="page-content-wrapper">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    %>
                                    <tr>
                                        <% int codigo=registro.getCodCliente();%>
                                        <td><%=codigo %></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="frmClientes.jsp?idCrearModificar=<%=codigo%>"> <i id="edit" class="fas fa-user-edit"></i> </a> |
                                            <!--Botón para Eliminar -->
                                            <a href="EliminarClientes?idEliminar=<%=codigo%>"> <i id="delete" class="fas fa-trash-alt"></i> </a> |
                                        </td>
                                    </tr>
                                    <%}%><!--Para cerrar el for --> 
                                </tbody>
                        ...
                        <a href="frmClientes.jsp?idCrearModificar=-1"> Agregar un nuevo Cliente </a> |
